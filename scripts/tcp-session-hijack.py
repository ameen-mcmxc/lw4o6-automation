...
# It acts according to the found source IPv6 address and the TCP flag.
...
def process_packet(packet):
    ...
    if TCP in packet and packet[IPv6].src == "2001:db8:0:1::2" and packet[TCP].flags == 'A':
        ...
        # SSH to the Attacker-2 and execute port exhaustion attack from there against the lwB4 machine
    ...
    # Check if the packet is a TCP packet with "A" flag heading from Server to Client
        ...
        sendp(pkt, iface='ens34')
        print(f"I just sent TCP Packet to the Server with P and A flags again")
